...
export function WeekStrip({ activeDays }: Props) {
  ...
  return (
    <View style={styles.row}>
      {days.map((day) => {
        const labelColor = day.isToday
          ? colors.neutral.textPrimary
          : colors.neutral.textSecondary;

        let circleBorder = colors.neutral.border;
        let circleBg: string = "transparent";
        let dateColor = colors.neutral.textPrimary;
        let borderStyle: "solid" | "dashed" = "dashed";

        if (day.isActive) {
          circleBorder = colors.semantic.success;
          circleBg = colors.semantic.success;
          dateColor = "#fff";
          borderStyle = "solid";
        } else if (day.isToday) {
          circleBorder = colors.primary.blue;
          borderStyle = "solid";
        }
