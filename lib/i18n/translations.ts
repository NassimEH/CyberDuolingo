...
export const fr: Record<TranslationKey, string> = {
  ...
  "profile.deleteAccountConfirmMessageApple": "Ton compte social (Apple ou Google), ton profil et ta progression seront définitivement effacés.",
...
export const en: Record<TranslationKey, string> = {
  ...
  "profile.deleteAccountConfirmMessageApple": "Your social account (Apple or Google), profile, and progress will be permanently deleted.",
